...
public class JsonUtil {
	...
	static {
		...
		DateMorpher dm = new DateMorpher(new String[] { DateUtil.YYYY_MM_DD, DateUtil.YYYY_MM_DD_HH_MM_ss,
				DateUtil.HH_MM_ss, DateUtil.YYYYMMDD, DateUtil.YYYYMMDDHHMMSS, DateUtil.HHMMss });
	...
	*/
	...
	public static String getJsonStr(Object obj, String format) {
		String jsonStr = null;
		// Json配置
		JsonConfig jsonCfg = new JsonConfig();

		// 注册日期处理器
		jsonCfg.registerJsonValueProcessor(java.util.Date.class, new JsonDateValueProcessor(format));
		if (obj == null) {
			return "{}";
		}
